...
class Dashboard extends Component {
    ...
    filterOrders = (k) => {
        ...
        if (k === 'today') {
            ...
            const todaysMilliseconds = new Date(`${yyyy}-${mm}-${dd}`).getTime() - 60 * 60 * 1000 * 3;

            let todaysOrders = this.props.orderList.filter((o) => o.data.timeStamp >= todaysMilliseconds);
            ...
            this.setState({
                filteredOrders: JSON.parse(JSON.stringify(this.props.orderList)).sort(
